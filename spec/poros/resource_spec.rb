...
RSpec.describe Resource do
  ...
  let!(:country) { 'Morocco' }
  let!(:resource) { Resource.new(video_data, country) }
  ...
  it 'exists and has attributes' do
    ...
    expect(resource.images).to eq([{
                                    alt_tag: 'Audio Requiring Attribution: Arab Instruments: https://commons.wikimedia.org/wiki/File:Playing_Darbuka_on_the_Beach.webm ...',
                                    url: 'https://i.ytimg.com/vi/dm9HJQNbU0M/hqdefault.jpg'
                                  }])
  end
end
